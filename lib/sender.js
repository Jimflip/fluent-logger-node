...
{  
  var self = this;
  var item = self._makePacketItem(label, data, null);
...
FluentSender.prototype.addEvent = function(label, data, time, callback)
{
  console.log('addEvent');

  var self = this;
  var item = self._makePacketItem(label, data, time);
  item.callback = callback;
  self._sendQueue.push(item);
  self._sendQueueTail++;
  self._connect(function(){
